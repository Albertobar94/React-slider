        ...
        <div className="testimonial-section">
            <div className="testimonial-container">
                <div
                    ...
                    <span>
                        <img src={ 'React-slider/' + leftArrow } alt="Left Arrow" />
                    </span>
                </div>
                ...
                <div className="inner">
                    <div className="t-image">
                        ...
                        >
                            ...
                            ><img src={'React-slider/' + testimonials[0].image} alt={testimonials[0].name + " image"} /></li>
                            <li
                                className={ state.isActive2 ? 'active' : ''}
                            ><img src={'React-slider/' + testimonials[1].image} alt={testimonials[1].name + " image"} /></li>
                            <li
                                className={ state.isActive3 ? 'active' : ''}
                            ><img src={'React-slider/' + testimonials[2].image} alt={testimonials[2].name + " image"} /></li>
                        </ul>
                    </div>
                ...
                <div
                    ...
                    <span>
                        <img src={ 'React-slider/' + rightArrow } alt="right Arrow" />
                    </span>
                </div>
            </div>
        </div>
